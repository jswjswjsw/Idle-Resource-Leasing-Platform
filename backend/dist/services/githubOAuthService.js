...
class GitHubOAuthService {
    ...
    async validateAccessToken(accessToken) {
        try {
            await axios_1.default.get('https://api.github.com/user', {
                headers: {
                    'Authorization': `Bearer ${accessToken}`,
                    'Accept': 'application/vnd.github.v3+json',
                    'User-Agent': 'Trade-Platform-App'
    ...
    async revokeAccessToken(accessToken) {
        try {
            await axios_1.default.delete(`https://api.github.com/applications/${this.clientId}/token`, {
                auth: {
...
//# sourceMappingURL=githubOAuthService.js.map